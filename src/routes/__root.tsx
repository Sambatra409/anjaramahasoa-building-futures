...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Association Anjaramahasoa" },
      { property: "og:description", content: "Part du Bien Commun — Éducation inclusive et durable à Ambatofahavalo." },
